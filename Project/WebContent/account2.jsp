...
<body>
	<div id="div1">
		<div id="top"><span id="top1">이체</span><span id="top2">고객명</span> <select name="" id="" style="width: 80px; height: 30px;">
			<option value="">---------</option>
			<option value="">---------</option>
			<option value="">---------</option>
			<option value="">---------</option>
		</select></div>
		<div>보내는 사람<input type="text" name="div2" id="div2" /></div>
		<div>송금할 계좌번호<input type="number" name="div3" id="div3" /></div>
		<div>계좌번호<input type="number" name="div4" id="div4" placeholder="  Password"/></div>
